<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    <!-- 棋盤背景 -->
    <rect width="200" height="200" fill="#DEB887" />
    ...
    <g>
        ...
        <text x="60" y="63" text-anchor="middle" fill="white" font-size="7">1</text>
    </g>

    <!-- 白2 -->
    <g>
        <circle cx="80" cy="60" r="8" fill="white" stroke="black" stroke-width="0.5" />
        <text x="80" y="63" text-anchor="middle" fill="black" font-size="7">2</text>
    </g>

    <!-- 黑3 -->
    <g>
        <circle cx="60" cy="80" r="8" fill="black" />
        <text x="60" y="83" text-anchor="middle" fill="white" font-size="7">3</text>
    </g>

    <!-- 白4 -->
    <g>
        <circle cx="60" cy="100" r="8" fill="white" stroke="black" stroke-width="0.5" />
        <text x="60" y="103" text-anchor="middle" fill="black" font-size="7">4</text>
    </g>

    <!-- 黑5 -->
    <g>
        <circle cx="80" cy="80" r="8" fill="black" />
        <text x="80" y="83" text-anchor="middle" fill="white" font-size="7">5</text>
    </g>
</svg>
<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- 白2 -->
  <g>
    <circle cx="100" cy="60" r="8" fill="white" stroke="black" stroke-width="0.5" />
    <text x="100" y="63" text-anchor="middle" fill="black" font-size="7">2</text>
  </g>
  ...
  <g>
    ...
    <text x="80" y="63" text-anchor="middle" fill="black" font-size="7">4</text>
  </g>
